    ...
    <div className={isHide ? 'd-none' : ''}>
      ...
      <Form.Row>
        <Form.Group as={Col} md="6" controlId="registerDateOfBirth" className="required">
          <Form.Control required type="date" defaultValue={(app.activeUser) ? app.activeUser.dateOfBirth : ''} placeholder="Date of Birth" name="dateOfBirth" isInvalid={Boolean(errors.entity && errors.entity.birthdate)} />
        ...
        <Form.Group as={Col} md="6" controlId="registerSSN" className="required">
          <Form.Control required placeholder="Social Security Number 123-34-5678" name="ssn" defaultValue={(app.activeUser) ? app.activeUser.ssn : ''} isInvalid={errors.identity} />
      ...
      <Form.Group controlId="registerAddress" className="required">
        <Form.Control required placeholder="Street Address" name="address" defaultValue={(app.activeUser) ? app.activeUser.address : ''} isInvalid={Boolean(errors.address && errors.address.street_address_1)} />
      ...
      <Form.Row className="mb-4">
        <Form.Group as={Col} md="4" controlId="registerCity" className="required">
          <Form.Control required placeholder="City" name="city" defaultValue={(app.activeUser) ? app.activeUser.city : ''} isInvalid={Boolean(errors.address && errors.address.city)} />
        ...
        <Form.Group as={Col} md="4" controlId="registerState" className="select required">
          <Form.Control required as="select" name="state" defaultValue={(app.activeUser) ? app.activeUser.state : ''} isInvalid={Boolean(errors.address && errors.address.state)}>
        ...
        <Form.Group as={Col} md="4" controlId="registerZip" className="required">
          <Form.Control required placeholder="Zip" name="zip" defaultValue={(app.activeUser) ? app.activeUser.zip : ''} isInvalid={Boolean(errors.address && errors.address.postal_code)} />
      ...
      <Form.Group controlId="registerDeviceFingerprint" className="readonly">
        <Form.Control required name="deviceFingerprint" readOnly={true}/>
      </Form.Group>
      <Form.Group controlId="registerSms" className="mb-5">
