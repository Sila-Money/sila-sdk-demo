...
const BusinessType = ({ page, previous, next }) => {
  ...
  return (
    <Container fluid className={`main-content-container d-flex flex-column flex-grow-1 loaded ${page.replace('/', '')}`}>
      ...
      <p className="mb-4 text-lg text-info">Please choose your business type and category. This will determine the information we need to collect from you moving forward.</p>
