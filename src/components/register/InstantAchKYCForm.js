...
const InstantAchKYCForm = ({ errors, children }) => {
  ...
  return (
    <>
      ...
      <Form.Group controlId="registerDeviceFingerprint" className="readonly">
        <Form.Control required name="device_fingerprint" readOnly={true}/>
      </Form.Group>
      <Form.Group controlId="registerSms" className="mb-5">
        <Form.Check custom id="registerSms" className="mb-5 ml-n2" type="checkbox">
          <Form.Check.Input name="register_sms" defaultChecked={receiveSMS} onChange={onSMSChange} type="checkbox" />
