...
const KYBFormFieldType = ({ fieldType, errors, app, onEditing, onSave }) => {
  ...
  return (
    <>
      {fieldType && fieldType === 'entity_name' && <Form.Group controlId="businessName" className="required mb-0">
      ...
      {fieldType && fieldType === 'doing_business_as' && <Form.Group controlId="businessDBA" className="required mb-0">
      ...
      {fieldType && fieldType === 'email' && <Form.Group controlId="businessEmail" className="required mb-0">
      ...
      {fieldType && fieldType === 'business_website' && <Form.Group controlId="businessWebsite" className="required mb-0">
      ...
      {fieldType && fieldType === 'address' && <Form.Group controlId="businessAddress" className="required mb-0">
      ...
      {fieldType && fieldType === 'city' && <Form.Group controlId="businessCity" className="required mb-0">
      ...
      {fieldType && fieldType === 'zip' && <Form.Group controlId="businessZip" className="required mb-0">
      ...
      {fieldType && fieldType === 'phone' && <Form.Group controlId="businessPhone" className="required mb-0">
      ...
      {fieldType && fieldType === 'ein' && <Form.Group controlId="businessEIN" className="required mb-0">
