  ...
  return (
    <>
      <Form noValidate className={className} validated={validated} autoComplete="off" onSubmit={register}>
        ...
        <p className="text-right text-info mb-4"><Button variant="link" className="text-reset font-italic p-0 text-decoration-none shadow-none" onClick={() => onShowKybModal(true)}><span className="lnk">What's the difference between the KYB levels?</span><i className="sila-icon info text-primary ml-2"></i></Button></p>
