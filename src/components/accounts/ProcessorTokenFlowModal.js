      ...
      <Modal.Body className="p-4">
        ...
        <Container className="bg-primary-light p-0">
          <Row className="mb-4 align-items-center">
            ...
            <Col sm={8}>
              <p className="text-info mb-0">Here we will walk you through step-by-step how to set up your Plaid account for integration and how to generate a processor token to link your bank account. This flow will be entirely simulated, and will provide you with a mock processor token at the end.</p>
            </Col>
          </Row>
          <Row className="mb-4 align-items-center">
            ...
            <Col sm={8}>
              <p className="text-info mb-0">With this flow, you will be able to generate your own processor token using your Plaid Sandbox credentials. Your credentials are held locally, and are completely secure. We will make calls on your behalf, which allows you to see the API responses in real-time. </p>
            </Col>
          </Row>
          <Row className="align-items-center">
            <Col sm={4}><Button onClick={onShowProcessorTokenModal} block className="mb-2 p-3">Provide Processor Token</Button></Col>
            <Col sm={8}>
              <p className="text-info mb-0">If you already have a processor token, all you need to do is supply the information and we can connect your bank account instantly.</p>
            </Col>
          </Row>
        </Container>
      </Modal.Body>
