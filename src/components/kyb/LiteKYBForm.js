  ...
  return (
    <>
      ...
      <Form.Row>
        ...
        <Form.Group as={Col} md="6" controlId="businessEmail" className="required mb-3">
      ...
      <Form.Group controlId="businessAddress" className="required mb-3">
      ...
      <Form.Row>
        <Form.Group as={Col} md="4" controlId="businessCity" className="required mb-3">
        ...
        <Form.Group as={Col} md="4" controlId="businessState" className="select required mb-3">
        ...
        <Form.Group as={Col} md="4" controlId="businessZip" className="required mb-3">
      ...
      <Form.Row>
        <Form.Group as={Col} md="6" controlId="businessPhone" className="required mb-3">
        ...
        {businessTypes && businessTypes.includes(app.settings.kybBusinessType) && <Form.Group as={Col} md="6" controlId="businessEIN">
          <Form.Control required={errors.identity ? true : false} placeholder="Employer ID Number (EIN) 12-3456789" name="ein" defaultValue={app.activeUser ? app.activeUser.ein : undefined} isInvalid={Boolean(errors.identity)} />
